...
public class CreateCampaignsUsingAssignedTo_Test8 {
	public static void main(String[] args) throws Throwable {
        ...
        String Group = elib.getDataFromExcel("Org", 1, 18);
...
//click on create camp btn
    	...
    	cncmpnP.createCampaigns(CampaignName, Group, CampaignType, CampaignStatus, closingDateEdit);
